...
const kfctlUrl = `https://github.com/kubeflow/kubeflow/releases/download/`;
...
function downloadKfctl(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec("wget", ["-O", path.join(kfctlPath, "kfctl.tar.gz"), kfctlVersionedUrl]);
...
function downloadKfConfig(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec("wget", ["-O", path.join(kfctlPath, "kfctl_k8s_istio" + versionCongfigPrefixUrl + ".yaml"), versionedConfigUrl]);
        yield exec.exec("cat", [path.join(kfctlPath, "kfctl_k8s_istio" + versionCongfigPrefixUrl + ".yaml")]);
    });
}
