...
function downloadKfConfig(version) {
    return __awaiter(this, void 0, void 0, function* () {
        const kfConfigUrl = `https://raw.githubusercontent.com/kubeflow/manifests/v0.7-branch/kfdef/kfctl_k8s_istio.0.7.0.yaml`;
        yield exec.exec("wget", ["-O", path.join(kfctlPath, "kfctl_k8s_istio.yaml"), kfConfigUrl]);
        yield exec.exec("cat", [path.join(kfctlPath, "kfctl_k8s_istio.yaml")]);
    });
}
