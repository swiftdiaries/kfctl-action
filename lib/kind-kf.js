...
function downloadKfctl(version) {
    return __awaiter(this, void 0, void 0, function* () {
        const kfctlPath = "/home/runner/bin";
        let kfConfigUrl = `https://raw.githubusercontent.com/kubeflow/manifests/master/kfdef/kfctl_k8s_istio.yaml`;
        yield io.mkdirP(kfctlPath);
        ...
        yield exec.exec(path.join(kfctlPath, "kfctl"), ["apply", "-V", "-f", kfConfigUrl]);
        core.addPath(kfctlPath);
    });
}
